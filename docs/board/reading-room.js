...
/* ======================= 10. THE OTHER GUYS =============================== */
{
  ...
  lede: `We looked at every company that rents margarita machines in the Austin area. There are about eight of them. Here is what they charge, how many Google reviews they have, what they are good at, and what they are bad at — and where you are already ahead.`,
  close: [
    ['If you only remember one thing',
     `Nobody in this market asks the guests for Google reviews. That is your biggest advantage. One rental puts 30–50 people in front of your machine, and every one of them has a phone. If three of them leave a Google review, that is more than most competitors collect in months. Twenty rentals with that system and you pass Hill Country Margaritas and close in on River City.`],
  ],
  groups: [
{
  name: 'Who they are and what they charge',
  color: '#4fc3f7',
  blurb: 'Eight dedicated margarita machine rental companies in the Austin area.',
  cards: [
    ['plain', 'The cheapest is $224, the most expensive is $350',
     `River City Frozen Beverages is the cheapest at $224 (they call it the "bargain package"). ATX Marg is the most expensive at about $350. You are at $250 — right in the middle, and that is a good place to be, especially now that Fresh Press at $375 is the premium option for people who want real fruit.`],
    ['number', 'Google reviews the top competitor has', '~200',
     `River City Frozen Beverages claims about 200 Google reviews. Hill Country Margaritas has 78. Those are the numbers that matter — Google reviews are what show up when someone searches "margarita machine rental near me." Yelp made this market look tiny, but Google tells a different story.`],
    ['plain', 'Your main competitors on Google',
     `Hill Country Margaritas (78 Google reviews, 5.0 stars) and River City (about 200, also 5.0) are the two biggest. Both put their Google review count right on their homepage. Crazy Party Rita’s lists Lakeway and Bee Cave as places they deliver. Margaritas To Go used to be a direct competitor but may have closed — people on Facebook are asking if they shut down.`],
...
{
  name: 'Google reviews — the big opportunity',
  color: '#ff4081',
  blurb: 'This is the most important section. Read it twice.',
  cards: [
    ['plain', 'Google reviews are the only ones that matter for getting found',
     `When someone searches "margarita machine rental" on their phone, Google shows a map with three businesses. Those three spots are chosen mostly by who has the most and best Google reviews. Yelp reviews do not help you get into that map. Google reviews do.`],
    ['plain', 'Every single review is from the person who booked',
     `We read every review every competitor has, on Google and Yelp. All of them — 100% — are from the person who booked the rental. Not one is from a party guest. Nobody in this entire market asks the guests.`],
    ['number', 'People at one of your parties who could review', '30–50',
     `Every rental puts 30 to 50 people in front of the machine. They are standing there with a drink and a phone. If you put a card on the table with a QR code to your Google review page, some of them will scan it. Three Google reviews from one party is more than most competitors collect in months.`],
    ['plain', 'The math',
     `Twenty rentals in a year, five Google reviews each from the guests plus the booker. That is 100 Google reviews. Hill Country Margaritas has 78 — you would pass them in year one. River City has about 200, but they have been around for years and cover a huge area. With the guest-review trick nobody else is doing, 100 reviews in your first year is very realistic.`],
    ...
    ['plain', 'Respond to every single review',
     `Woolf’s Ritas responds to every review they get. Hill Country Margaritas has a perfect 5.0 on 78 reviews — they clearly care about every one. Do what they do. When a review comes in, reply within 24 hours. Keep it short and from you two: "Thank you Ashley! We loved your party — the watermelon was a hit!" It tells people you are paying attention and encourages others to leave one too.`],
  ],
},
{
